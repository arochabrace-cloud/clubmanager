...
const FormSchema = z
  .object({
    ...
    // Optional: allow direct linking to a member (e.g., through invite)
...
export default function RegisterPage() {
  ...
  const callbackUrl = sp.get("callbackUrl") || "/member"; // where to land after auto-login
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      if (res?.error) {
        // If login fails (shouldn't), send to login page.
        router.push(
  ...
  return (
    <div className="mx-auto max-w-md mt-10 border rounded-lg p-6 space-y-5 bg-white">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        {/* Optional: link to an existing Member record (e.g., from an invite) */}
        <div>
